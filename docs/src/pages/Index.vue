    ...
    <div class="pt-8 md:pt-16">
      <div class="flex flex-col items-center">
        ...
        <p class="text-xl font-medium text-center">
          Documentation for N-Body Simulations.
          <br>
          <strong class="text-ui-primary">Got a minute?</strong>
        </p>

        <div class="py-4">
          <code class="block px-4 py-1 select-all bg-ui-border text-ui-typo">gh repo clone sparxastronomy/Nbody</code>
        </div>
      ...
      <div class="flex flex-wrap justify-center -mx-4">
        <div class="flex flex-col items-center w-full px-4 mb-8 text-center md:w-1/3">
          ...
          <p class="text-lg text-left">
            Easy to understand, written in python, optimezed using numba.
          </p>
        </div>
        ...
        <div class="flex flex-col items-center w-full px-4 mb-8 text-center md:w-1/3">
          ...
          <p class="text-lg text-left">
            All contents are indexed. Instant search powered by Fuse.js. Find what you are looking for in the <span class="border-b border-dashed border-ui-primary text-ui-primary">blink of an eye</span>.
          </p>
        </div>
