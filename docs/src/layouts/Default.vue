...
h3,
h4 {
  @apply leading-snug tracking-wider font-black mb-4 text-ui-typo;
...
.content {
  ...
  p{
    @apply text-xl tracking-wide mx-auto;
  ...
  ol,
  ul {
    @apply ml-3 pl-3 py-1;

    li {
      @apply my-1 text-lg tracking-wider italic font-serif font-light;
